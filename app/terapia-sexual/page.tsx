...
const WHATSAPP_URL =
  'https://wa.me/56937389719?text=Hola%2C%20me%20gustar%C3%ADa%20agendar%20una%20consulta%20de%20terapia%20sexual.';
    ...
    <>
      ...
      <div className="min-h-screen bg-white text-slate-700" style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
        ...
        <main className="pt-[72px]">
          ...
          <DanielReyes_GoogleReviews reviews={googleReviewSets.sexual} />
